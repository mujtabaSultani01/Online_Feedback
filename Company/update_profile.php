<?php
	...
	mysqli_query($conn,"update Company set Name='$n',designation	='$desg',programme='$prg',semester='$sem',mobile='$mob',	password='$pass' where email='".$_SESSION['faculty_login']."'");	

$err="<font color='green'>Company Details updated</font>";

	}

$con=mysqli_query($conn,"select * from Company where email='".$_SESSION['Company_login']."'");
