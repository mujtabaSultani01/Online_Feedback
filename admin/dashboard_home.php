...
<?php 
//all complaints
$qq=mysqli_query($conn,"select * from Company ");
$rows=mysqli_num_rows($qq);			
echo "<h2 style='color:green'>Total Number of Company: $rows</h2>";	

//all emegency compalints
$q=mysqli_query($conn,"select * from user");
$r1=mysqli_num_rows($q);			
echo "<h2 style='color:orange'>Total Number of  Employee $r1</h2>";	
