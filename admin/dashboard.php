    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php">Company Feedback System</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="dashboard.php?info=add_Company"><i class="fa fa-plus fa-fw"></i> Add Company</a>
                                </li>
								 <li>
                                    <a href="dashboard.php?info=show_Company"><i class="fa fa-eye"></i> Manage Company</a>
                                </li>                           
							</ul>
                            <!-- /.nav-second-level -->
                        </li>
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
								 ...
								 <li>
                                    <a href="dashboard.php?info=display_ Employee"><i class="fa fa-eye"></i> Manage  Employee</a>
                                </li> 
                ...
                <div class="col-lg-12">
                	...
                	<?php 
								...
								if($info!="")
								{
									...
									elseif($info=="show_Company")
										{
											include('show_Company.php');
										}
										
										
									elseif($info=="edit_Company")
										{
											include('edit_Company.php');
										}	
										
									elseif($info=="display_ Employee")
										{
											include('display_ Employee.php');
										}
