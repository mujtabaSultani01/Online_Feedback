...
<?php
	...
	$i=1;
	$que=mysqli_query($conn,"select * from Company");
	...
	while($row=mysqli_fetch_array($que))
	{
		...
		echo "<td class='text-center'><a href='dashboard.php?id=$row[id]&info=edit_Company'><span class='glyphicon glyphicon-pencil'style=color:green;></span></a></td>";
