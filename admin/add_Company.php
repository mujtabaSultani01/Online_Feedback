...
$q=mysqli_query($conn,"select * from Company  where email='$email'");
	$r=mysqli_num_rows($q);	
	if($r)
	{
	...
	{	
		mysqli_query($conn,"insert into Company values('','$user_name','$name','$Designation','$prg','$sem','$email','$pass','$mob',now(),'0')");
	...
	$err="<font color='green'>New Company Successfully Added.</font>";
	}
	}
}	
...
<div class="col-lg-8" style="margin:15px;">
  ...
  <select name="sem" class="form-control" required>
	...
	<div class="control-group form-group">
    	<div class="controls">
            	<input type="submit" class="btn btn-success" name="save" value="Add New Company">
        </div>
  	</div>
	</form>
