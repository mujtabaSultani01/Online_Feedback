...
<head>
	...
	<title>Online ATRA System</title>
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#66CCFF">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#FFFFFF">Online ATRA System</a>
	...
	<li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="index.php?info=login"> Employee</a></li>
		  <li><a href="index.php?info=Company_login">Company</a></li> 
        ...
        <div class="row">
			...
			<div class="col-sm-10" style="margin-top:60px;margin-bottom:80px">
				<h2>About Faculty feedback System</h2>
				 Employee  Feedback system for College in PHP(SOurce code) 
...
Before we can look into the php code, you need to create a database called "feed" with two tables in it..one as  Employee  
and another one as take
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#66CCFF">
		<span style="color:#FFFFFF">Developed By ....... 	<a href="http://www.phptpoint.com">Ajazulhaq Afzali</a> </span>
	</div>
    <!-- jQuery -->
